...
class Categories extends CI_Controller {
	...
	public function process($mode,$id='')
	{
		...
		if(($mode=='insert') || ($mode=='update'))
		{
			...
			{
			$result = ($mode=='insert') ? $this->datamodel
			->insert_entry($this->upload->file_name) : 
			$this->datamodel
			->update_entry($this->upload->file_name);
			}
		}else if($mode=='delete'){
